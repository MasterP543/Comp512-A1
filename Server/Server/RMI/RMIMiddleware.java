...
public class RMIMiddleware extends Middleware {
    ...
    private static String customers_RM = "Customers";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResourceManager customers = new ResourceManager(customers_RM);

            RMIMiddleware middleware = new RMIMiddleware(s_serverName, flightsStub, carsStub, roomsStub, customers);
    ...
    public RMIMiddleware(String s_serverName, IResourceManager flights, IResourceManager cars, IResourceManager rooms, ResourceManager customers) throws RemoteException {
